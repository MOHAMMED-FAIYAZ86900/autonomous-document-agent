...
class AgentState(BaseModel):
    ...
    execution_plan: str | None = Field(
        default=None, description="Generated execution plan."
    )

    assumptions: list[str] = Field(
        default_factory=list, description="Planner assumptions."
    )
    ...
    reflection: str | None = Field(default=None, description="Reflection feedback.")

    output_file: str | None = Field(default=None, description="Generated DOCX path.")

    status: str = Field(default="pending", description="Current agent status.")
